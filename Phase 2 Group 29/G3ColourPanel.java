...
import java.awt.event.*;
    ...
    /**
     * G3ColourPanel is visible on G3 and enabled the player to colour the nodes. It uses objects of ClickColour.
     * @param passedNodes
     * @param graphPanel
     * 
     */
public class G3ColourPanel extends JComponent
{
    ...
    public G3ColourPanel(ArrayList<Node> passedNodes, G3 g3)
    
    {
        ...
        class MousePressListener implements MouseListener
        {
            ...
            public void mouseClicked(MouseEvent e) 
            {
                ...
                g3.setColourCounter(getColourCount());
